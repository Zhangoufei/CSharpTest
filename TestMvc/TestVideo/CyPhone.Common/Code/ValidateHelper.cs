...
namespace CyPhone.Common
{
    ...
    public class ValidateHelper
    {
        ...
        //数字账号
        private static Regex _useridregex = new Regex(@"^[1-9]\d*$");
        //匹配学籍号一位字母+18位数字
        private static Regex _schoolnumregex = new Regex(@"^(G|J|L|S)(\d{18}|\d{10})$");
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public static bool IsUserId(string s)
        {
            if (string.IsNullOrEmpty(s))
                return true;
            return _useridregex.IsMatch(s);
        }
        /// <summary>
        /// 是否为学籍号
        /// </summary>
        /// <param name="s"></param>
        /// <returns></returns>
        public static bool IsSchoolNum(string s)
        {
            if (string.IsNullOrEmpty(s))
                return true;
            return _schoolnumregex.IsMatch(s);
        }
        /// <summary>
        /// 是否为邮箱名
        /// </summary>
