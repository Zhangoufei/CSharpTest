...
//                    break;
    ...
    function createPreviewVideo(url){
        ...
        $G("preview").innerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0"' +
        ' width="' + 420  + '"' +
        ' height="' + 280  + '">' +
		'<param name="movie" value="/Scripts/flvplayer.swf?vcastr_file='+url+'&amp;IsAutoPlay=1"/>'+
		'<param name="quality" value="high"/>'+
		'<param name="allowFullScreen" value="true"/>'+
		'<embed src="/Scripts/flvplayer.swf" allowfullscreen="true" flashvars="vcastr_file='+url+'&amp;IsAutoPlay=1" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="'+420+'" height="'+280+'"/>'+
        '</object>';
    }
