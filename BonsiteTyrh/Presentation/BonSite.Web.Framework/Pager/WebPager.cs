...
namespace BonSite.Web.Framework
{
    ...
    public class WebPager : Pager
    {
        ...
        public sealed override string ToHtmlString()
        {
            ...
            StringBuilder html = new StringBuilder("<div class=\"pagelist\">");
            ...
            if (_showfirst)
            {
                if (_pagemodel.IsFirstPage)
                    html.Append("");
                    //html.Append("<a href=\"javascript:void(0)\" class=\"die\">首页</a>");
                else
            ...
            if (_showpre)
            {
                if (_pagemodel.HasPrePage)
                    ...
                    html.Append("");
                    //html.Append("<a href=\"javascript:void(0)\" class=\"die\">上一页</a>");
            }
            ...
            if (_shownext)
            {
                if (_pagemodel.HasNextPage)
                    ...
                    html.Append("");
                    //html.Append("<a href=\"javascript:void(0)\" class=\"die\">下一页</a>");
            }

            if (_showlast)
            {
                if (_pagemodel.IsLastPage)
                    //html.Append("<a href=\"javascript:void(0)\" class=\"die\">末页</a>");
                    html.Append("");
                else
