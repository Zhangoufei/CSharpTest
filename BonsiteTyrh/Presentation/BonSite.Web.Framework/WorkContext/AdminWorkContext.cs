...
namespace BonSite.Web.Framework
{
    public class AdminWorkContext
    {
        ...
        public SiteConfigInfo SiteConfig = BSConfig.SiteConfig;//商城配置信息
        ...
        public string UserRankTitle;//用户等级标题

        public int AdminGroupID = -1;//用户管理员组id

        public AdminGroupInfo AdminGroupInfo;//用户管理员组信息

        public string AdminGroupTitle;//管理员组标题
        ...
        public string SiteVersion = BSVersion.SITE_VERSION;//程序版本

        public string SiteCopyright = BSVersion.SITE_COPYRIGHT;//程序版权
    }
}
