...
namespace BonSite.Services
{
    ...
    public class Randoms
    {
        ...
        static Randoms()
        {
            _irandomstrategy = BSRandom.Instance;
            if (!string.IsNullOrWhiteSpace(BSConfig.SiteConfig.RandomLibrary))
            {
                _irandomstrategy.RandomLibrary = BSConfig.SiteConfig.RandomLibrary.ToCharArray();
            }
        }
