...
namespace BonSite.Data
{
    public class Adverts
    {
        ...
        public static List<AdvertPositionInfo> GetAdvertPositionList(int pageSize, int pageNumber)
        {
            ...
            IDataReader reader = BonSite.Core.BSData.RDBS.GetAdvertPositionList(pageSize, pageNumber);
            while (reader.Read())
            {
        ...
        {
            return BonSite.Core.BSData.RDBS.GetAdvertPositionCount();
        }
        ...
        {
            List<AdvertPositionInfo> advertPositionList = new List<AdvertPositionInfo>();
            IDataReader reader = BonSite.Core.BSData.RDBS.GetAllAdvertPosition();
            while (reader.Read())
            {
                AdvertPositionInfo advertPositionInfo = BuildAdvertPositionFromReader(reader);
                advertPositionList.Add(advertPositionInfo);
        ...
        {
            BonSite.Core.BSData.RDBS.CreateAdvertPosition(advertPositionInfo);
        }
        ...
        public static AdvertPositionInfo GetAdvertPositionById(int adPosId)
        {
            ...
            IDataReader reader = BonSite.Core.BSData.RDBS.GetAdvertPositionById(adPosId);
            if (reader.Read())
            {
        ...
        {
            BonSite.Core.BSData.RDBS.DeleteAdvertPositionById(adPosId);
        }
        ...
        {
            BonSite.Core.BSData.RDBS.CreateAdvert(advertInfo);
        }
        ...
        {
            BonSite.Core.BSData.RDBS.DeleteAdvertById(adId);
        }
        ...
        public static AdvertInfo AdminGetAdvertById(int adId)
        {
            ...
            IDataReader reader = BonSite.Core.BSData.RDBS.AdminGetAdvertById(adId);
            if (reader.Read())
            {
        ...
        {
            return BonSite.Core.BSData.RDBS.AdminGetAdvertList(pageSize, pageNumber, adPosId);
        }
        ...
        {
            return BonSite.Core.BSData.RDBS.AdminGetAdvertCount(adPosId);
        }
        ...
        public static List<AdvertInfo> GetAdvertList(int adPosId, DateTime nowTime)
        {
            ...
            IDataReader reader = BonSite.Core.BSData.RDBS.GetAdvertList(adPosId, nowTime);
            while (reader.Read())
            {
