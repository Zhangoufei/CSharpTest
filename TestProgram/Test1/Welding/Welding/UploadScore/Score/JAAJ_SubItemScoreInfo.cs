...
namespace JAAJ.Model
{
    ...
    public class JAAJ_SubItemScoreInfo
    {
        ...
        public string nvcExamineeGUID
        {
            get
            {
                return m_nvcExamineeGUID;
            }
            set
            {
                m_nvcExamineeGUID = value;
            }
        }
        ...
        public string nvcSubjectName
        {
            get
            {
                return m_nvcSubjectName;
            }
            set
            {
                m_nvcSubjectName = value;
            }
        }
        ...
        public string nvcSubjectItemName
        {
            get
            {
                return m_nvcSubjectItemName;
            }
            set
            {
                m_nvcSubjectItemName = value;
            }
        }
        ...
        public string nvcTitleName
        {
            get
            {
                return m_nvcTitleName;
            }
            set
            {
                m_nvcTitleName = value;
            }
        }
        ...
        public decimal decSubjectItemScore
        {
            get
            {
                return m_decdecSubjectItemScore;
            }
            set
            {
                m_decdecSubjectItemScore = value;
            }
        }
        ...
        public DateTime datScoreDate
        {
            get
            {
                return m_datScoreDate;
            }
            set
            {
                m_datScoreDate = value;
            }
        }
        ...
        public List<JAAJ_StepScoreInfo> JAAJ_StepScoreInfoList
        {
            get
            {
                return m_ossiJAAJ_StepScoreInfoList;
            }
            set
            {
                m_ossiJAAJ_StepScoreInfoList = value;
            }
        }
